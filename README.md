...
- **Bacharel em Sistemas de Informação** — Centro Universitário Maurício de Nassau (UNINASSAU) – Graças, Recife/PE (2025)  
- **Técnico em Manutenção e Suporte em Informática** — Escola Técnica Estadual Professor Agamenon Magalhães (ETEPAM) – Recife/PE (2020)  
- Atualmente aprofundando conhecimentos em **Next.js, React, Ruby, Big Data, Machine Learning, Python e Node.js**  
- Perfil criativo, com facilidade em aprender e ensinar, forte raciocínio lógico e excelente trabalho em equipe  
